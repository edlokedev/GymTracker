...
export function WorkoutSummaryStats({ stats, isLoading }: WorkoutSummaryStatsProps) {
      ...
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M8 7V3a2 2 0 012-2h4a2 2 0 012 2v4m-6 0V6a2 2 0 012-2h4a2 2 0 012 2v1m-6 0h6m-6 0a2 2 0 00-2 2v8a2 2 0 002 2h6a2 2 0 002-2V9a2 2 0 00-2-2m-6 0h6"
          />
        </svg>
      ),
  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
      {statCards.map((stat) => (
        <div key={stat.title} className="workout-stat min-h-[100px] sm:min-h-[120px]">
          <div className="flex items-start justify-between h-full">
            <div className="flex-1 min-w-0">
              ...
              <p className="text-lg sm:text-xl font-bold mt-1 gradient-text">{stat.value}</p>
            </div>
